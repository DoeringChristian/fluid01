...
void main(){
    ...
    float fallout = (1 - length(vo.xy)/VMAX);
    ...
    o_float = tex(r - dt * vo.xy, t_tex_float, s_tex_float) * (1. - fallout) + tex(r, t_tex_color, s_tex_color) * pickup + exp(-dot(r-m, r-m)/50.) * brush_color;
